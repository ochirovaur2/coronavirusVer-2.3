...
<!-- /Yandex.Metrika counter -->
    ...
    <style>
        #map {
            width: 80%; height: 40vh; padding: ; margin: 2.5rem auto;
        }
  ...
  <body>
      ...
      <div class="container">
        ...
        <nav class="nav" id="nav">
          <ul class="nav__list">
            ...
            <li class="nav__item"><a href="#yak2" class="nav__link">Новости</a></li>
            <li class="nav__item"><a href="#yak3" class="nav__link">Китай</a></li>
            <li class="nav__item"><a href="#yak4" class="nav__link">Мир</a></li>
          </ul>
        </nav>
      </div>
    </div>
    ...
    <main class="main">
      ...
      <section class="summaryRussia section " id="yak1"> 
        ...
        <p class="paragraph my-b-normal u-center-text paragraph__table">Данные обновлены: 12 марта 2020, 06:00:00 </p>
	...
	<section class="section" id="yak2">
      ...
      <section class="summaryChina section " id="yak3">
      ...
      <section class="summaryOutside section" id="yak4">
    ...
    <footer class="footer">
      <div class="container main-footer">
        ...
        <div class="social">
          ...
          <!--<a href="http://bsu.ru/"><span class="footer__bsu-span"><img src="./img/logos/logobsu.png" alt="bsu" class="footer__logo"></span></a>-->
        </div>
      </div>
      <div class="container footer__second">
        ...
        <a href="version.html" class="footer__site-version">Version 2.0</a>
      </div>
