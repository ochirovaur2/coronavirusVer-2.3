...
<!-- /Yandex.Metrika counter -->
    ...
    <style>
        #map {
            width: 80vw; height: 40vh; padding: ; margin: 2.5rem auto;
        }
  ...
  <body>
    ...
    <main class="main">
      ...
      <section class="summaryRussia section " id="yak1"> 
        ...
        <div class="container my-b-normal">
    		...
    		<div class="container">
    			<ul class="news">
    				<?php
                        ...
                        ?>
                        <li>
                            <a href="<?php echo $item['link']; ?>" target="_blank"><?php echo $item['title'];   ?><span class="paragraph__died"> <?php echo $item['time'];   ?></span></a> 
                        </li>
                        <?php
                        }
                        ?>
...
<!-- /Yandex.Metrika counter -->
        ...
        <a href="version.html" class="footer__site-version">Version 2.3</a>
      </div>
